...
NOTE: O número de discos de dados listados nas tabelas abaixo é como 9,7 P5. Nas versões anteriores do 9,7, dois discos de dados adicionais foram suportados. A partir de 9,7 P5, o Cloud Volumes ONTAP usa um disco adicional para dados de núcleo e outro para VNVRAM. Essa alteração reduziu o número de discos disponíveis para os dados.
